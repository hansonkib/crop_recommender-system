...
<body>
        <!-- navigation -->
        <nav class="navbar navbar-dark navbar-expand-md bg-danger navigation-clean">
            <div class="container"><a class="navbar-brand" href="#">REGIONS LIKELY TO GROW <?php echo $crop_name ?> </a>
                ...
                <div class="collapse navbar-collapse"
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link" href="regions.php
                            
                            ">Regions</a></li>
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Dropdown </a>
                            <div class="dropdown-menu" role="menu"><a class="dropdown-item"
                             role="presentation" href="#">Crops</a><a class="dropdown-item"
                              role="presentation" href="#">Regions</a><a class="dropdown-item" 
                              role="presentation" href="#">Climate</a></div>
                        </li>
                    </ul>
                </div>
            </div>
