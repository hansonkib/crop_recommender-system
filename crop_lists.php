...
$max_temp=$temperature_value + 5;
$min_temp=$temperature_value - 5;
$min_rainfall=$rainfall_value - 10;
$max_rainfall=$rainfall_value + 10;
?>
<?php
...
<body>
    ...
    $res=mysqli_query($link,"select * from crop where temperature>='" . $min_temp ."' AND temperature<='" . $max_temp ."' AND rainfall>='" . $min_rainfall ."' AND rainfall<='" . $max_rainfall ."'");
    ...
    <div class="col-sm-4 plan price yellow wow fadeInDown" style="width: 800px;">
        <ul class="list-group">
            ...
            <li class="list-group-item"><span>Aggregate rainfall:<?php echo $rainfall_value?> mm</span></li>
            <li class="list-group-item"><span>Aggregate Temperature:<?php echo $temperature_value?> celsious</span></li>
        </ul>
    </div>
